							...
							<div class="card">
								<div class="card-body">
									...
									<?php } else { ?>
										...
										<p id="newACPStatus"><b>NLAD Status:</b> <?php echo $data['acp_status']; ?></p>
									<?php } ?>
									<p><b>ETC:</b> <?php echo ($data['ETC']=="GTW")?"American Asistance":$data['ETC']; ?></p>
											...
											<form id="status-form" action="#" method="post" enctype="application/x-www-form-urlencoded">
												<div class="row">
													<div class="col-md-12">
														...
														<input type="hidden" name="username" id="status-username" value="<?php echo $_SESSION['email']; ?>">
													...
													<?php } else { ?>
														...
														<div class="row">
															<div class="col-md-12">
																...
																<input type="hidden" name="username" id="staff-username" value="<?php echo $_SESSION['name']; ?>">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form id="formRecordEdit">
					...
					<input type="hidden" value="<?php echo $data['customer_id']; ?>" id="leadCustomerId">
...
<script>
		...
		$(document).ready(function() {
			...
			$("#notify-documents").click(function() {
				...
				var customer_id = $("#leadCustomerId").val();
			...
			$("#submit-status").click(function() {
				...
				var id_order = $("#id_order").val();
				var username = $("#status-username").val();
