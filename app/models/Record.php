...
class Record {
	...
	public function getAllRecords(){
		$this->db->query('SELECT id, customer_id, first_name, second_name, phone_number, email, dob, city, state, zipcode, order_id, order_status, lp.name as program_benefit, created_at FROM lifeline_records lr LEFT JOIN lifeline_programs lp ON lp.id_program = lr.program_benefit ORDER BY created_at DESC');
		return $this->db->resultSet();
	}
